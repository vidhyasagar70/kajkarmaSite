 ...
 const steps = [
  {
    ...
    description:
      "Business validation, feature planning, and system architecture design.",
  },
  {
    number: "02.",
    title: "UI/UX & Experience Design",
    description:
      "Wireframing and responsive design for web and mobile.",
  },
  {
    number: "03.",
    title: "Development & Quality Assurance",
    description:
      "Unified web and app development with testing and optimization.",
  },
  {
    number: "04.",
    title: "Launch & Growth Monitoring",
    description:
      "Deployment, analytics setup, and continuous performance tracking.",
  },
];
