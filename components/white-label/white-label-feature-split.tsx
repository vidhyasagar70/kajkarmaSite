...
interface WhiteLabelFeatureSplitProps {
...
export function WhiteLabelFeatureSplit({
    title,
    description,
    imageSrc,
    imageAlt = "White Label Feature",
    reverse = false,
    ctaText,
    ctaHref = "#",
    points
}: WhiteLabelFeatureSplitProps) {
    return (
        <section className={cn("w-full py-16 sm:py-20 md:py-24 px-4 sm:px-6 lg:px-8", reverse ? "bg-white" : "bg-[#FBF9FE]")}>
