...
const steps: ProcessStep[] = [
    {
        ...
        description: "We begin by understanding your vision, target market, and business model. We identify core features required to validate demand and eliminate unnecessary complexity."
    },
    {
        phase: "Phase 2",
        title: "Architecture & UX Design",
        description: "Before writing code, we design scalable system architecture and intuitive user experiences."
    },
    {
        phase: "Phase 3",
        title: "Development & Integration",
        description: "We develop your MVP using modern frameworks and scalable backend systems."
    },
    {
        phase: "Phase 4",
        title: "Testing & Launch",
        description: "Once validated, we deploy your MVP and prepare you for market entry."
    }
];
            ...
            <div className="max-w-[1400px] mx-auto">
                <div className="text-center mb-16">
                    <h2 className="font-clash font-medium text-[32px] sm:text-[42px] md:text-[54px] text-[#0A0E31] mb-5">
                        Our MVP Development <span className="text-[#9220E1]">Approach</span>
                    </h2>
                    <p className="font-geist font-light text-[17px] sm:text-[19px] text-[#0A0E31]/60 max-w-3xl mx-auto">
                        We follow a structured, startup-focused process designed to minimize risk and maximize clarity.
                    </p>
                </div>
