...
const faqItems: FAQItem[] = [
    {
        question: "What is the purpose of MVP development?",
        answer: "MVP development helps startups validate product ideas with minimal risk and reduced cost before full-scale development."
    },
    {
        question: "Can an MVP become a full product?",
        answer: "Yes. When built correctly with scalable architecture, an MVP can evolve into a full-featured platform."
    },
    {
        question: "How long does it take to build an MVP?",
        answer: "Most MVPs take between 4 and 8 weeks depending on complexity."
    },
    {
        question: "Is MVP development suitable for marketplaces?",
        answer: "Yes. We specialize in marketplace MVP development including multi-vendor systems."
    },
    {
        question: "Do you provide post-launch support?",
        answer: "Yes. We offer ongoing development, feature expansion, and scaling support."
    }
];
        ...
        <section className="w-full py-20 sm:py-28 px-4 sm:px-6 lg:px-8 bg-white">
            <div className="max-w-[1000px] mx-auto">
                ...
                <div className="mt-16 text-center">
                    ...
                    >
                        Have Questions About MVP Development?
                    </button>
                </div>
            </div>
        </section>
