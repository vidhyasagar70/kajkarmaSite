...
export function AutomationCTA() {
    return (
        <section className="w-full py-20 sm:py-28 px-4 sm:px-6 lg:px-8 bg-[#0A0E31] relative overflow-hidden">
            {/* Background Glows */}
            <div className="absolute top-0 right-0 size-[400px] bg-[#9220E1] blur-[150px] opacity-15 -mr-48 -mt-48" />
            <div className="absolute bottom-0 left-0 size-[400px] bg-[#7C3AED] blur-[150px] opacity-15 -ml-48 -mb-48" />
            ...
            <div className="max-w-[1400px] mx-auto relative z-10">
                <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
                    ...
                    >
                        <button
                            className="font-geist flex items-center justify-center transition-all duration-300 bg-[#9220E1] text-white rounded-full font-medium shadow-xl shadow-[#9220E1]/15 hover:bg-[#7C3AED] hover:scale-[1.03] active:scale-[0.98] group"
                            style={{
                                padding: "14px 28px",
                                fontSize: "16px",
                            }}
