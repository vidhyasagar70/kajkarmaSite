    ...
    >
      <div className="max-w-[1400px] mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-[93px]">
          ...
          <div 
            className={`relative w-full max-w-[500px] lg:w-[500px] flex-shrink-0 transition-all duration-700 ease-out ${
          ...
          {/* Right - Content */}
          <div 
            className={`flex-1 w-full lg:w-[710px] lg:max-w-[710px] transition-all duration-700 ease-out delay-200 ${
              isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-12"
            }`}
          >
            {/* Heading */}
            ...
            <div className="space-y-5 sm:space-y-6 lg:space-y-[40px] mb-8 sm:mb-10 lg:mb-[40px]">
              {descriptions.map((desc, index) => (
                <p 
                  ...
                  } leading-[1.4] lg:leading-[32px] tracking-[0%] text-[#4A5568] transition-all duration-500 ease-out ${
            ...
            <button 
              ...
              className={`inline-flex items-center justify-center gap-[10px] px-6 py-4 rounded-[1000px] border border-[#0C1B33] bg-transparent text-[#0C1B33] font-medium text-base hover:bg-[#0C1B33] hover:text-white transition-all duration-300 ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
              }`}
              style={{
                minWidth: "205px",
