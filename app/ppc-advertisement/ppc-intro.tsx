                ...
                <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
                    ...
                    >
                        <h2 className="font-clash font-medium text-[32px] sm:text-[40px] md:text-[48px] leading-[1.1] text-[#0A0E31]">
                            What Is <span className="text-[#9220E1]">PPC Marketing?</span>
                        </h2>

                        <div className="flex flex-col gap-5">
                            <p className="font-geist font-light text-[16px] sm:text-[18px] md:text-[19px] leading-relaxed text-[#0A0E31]/70">
                                Pay-Per-Click (PPC) marketing is a paid advertising strategy where you pay only when someone clicks your ad. But effective PPC is not just about traffic — it’s about targeting the right audience with the right message at the right time.
                                <br /><br />
                                Strategic PPC marketing helps businesses:
                            </p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-6 mt-2">
                                {[
                                    ...
                                    "Dominate competitive search terms"
                                ].map((point) => (
                            ...
                            <div className="mt-4">
                                ...
                                >
                                    Start Generating High-Intent Traffic
