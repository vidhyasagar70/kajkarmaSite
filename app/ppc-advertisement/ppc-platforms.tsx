...
const platforms = [
    {
        title: "Google Ads",
        description: "Search ads, Display, Performance Max, Shopping, YouTube video ads, and Remarketing campaigns. Structured around conversion tracking and cost efficiency."
    },
    {
        title: "Meta Ads (Facebook & Instagram)",
        description: "Lead generation, Ecommerce sales, Retargeting funnels, Brand awareness, Creative A/B testing, and Audience segmentation."
    }
];

export function PPCPlatforms() {
    return (
            ...
            <div className="max-w-[1400px] mx-auto flex flex-col items-center">
                <div className="text-center mb-16 max-w-3xl mx-auto">
                    ...
                    <p className="font-geist font-light text-[17px] sm:text-[19px] text-[#0A0E31]/60">
                        We manage performance campaigns across major paid advertising platforms with a focus on data and ROI.
                    </p>
                </div>
                ...
                <div className="mt-12 flex flex-col sm:flex-row gap-4">
                    ...
                    <button
                        className="font-geist flex items-center justify-center transition-all duration-200 active:scale-[0.97] bg-[#FBF9FE] text-[#9220E1] border border-[#9220E1]/20 rounded-full font-medium hover:bg-[#9220E1]/5"
                        style={{
                            padding: "10px 22px",
                            fontSize: "14px",
                        }}
                    >
                        Scale With Meta Advertising
                        <svg className="ml-2 w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            <line x1="5" y1="12" x2="19" y2="12" />
                            <polyline points="12 5 19 12 12 19" />
                        </svg>
