...
const steps = [
  {
    ...
    description: "Best for stable campaigns with predictable workloads.",
  },
  {
    number: "02.",
    title: "Percentage of Ad Spend",
    description: "Performance-based pricing aligned with ad investment.",
  },
  {
    number: "03.",
    title: "Hybrid Pricing Model",
    description: "Combination of fixed fee and performance-based structure.",
  },
  {
    number: "04.",
    title: "Custom Growth Plans",
    description: "Tailored strategies for complex or large-scale campaigns.",
  },
];
