...
const steps = [
  ...
  },
  {
    ...
    description:
      "Focus on high-impact features, avoid unnecessary complexity.",
  },
  {
    number: "03.",
    title: "Rapid Development",
    description:
      "Build fast with agile, flexible, iterative releases.",
  },
  {
    number: "04.",
    title: "Launch & Scale",
    description:
      "Launch confidently, track usage, scale with insights.",
  },
];
