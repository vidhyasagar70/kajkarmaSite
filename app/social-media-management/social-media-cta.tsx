...
export function SocialMediaCTA() {
    return (
        <section className="w-full py-24 sm:py-32 px-4 sm:px-6 lg:px-8 bg-[#0A0E31] overflow-hidden relative">
            <div className="absolute top-1/2 left-0 w-[500px] h-[500px] bg-[#9220E1]/10 rounded-full blur-[120px] -translate-x-1/2 -translate-y-1/2 pointer-events-none" />
            ...
            <div className="max-w-[1400px] mx-auto relative z-10 flex flex-col items-center text-center">
                ...
                >
                    <h2 className="font-clash font-medium text-[36px] sm:text-[48px] md:text-[68px] leading-[1.05] text-white mb-8">
                        Build a Social Presence That <br /> <span className="text-[#9220E1]">Drives Business Growth</span>
                    </h2>

                    <p className="font-geist font-light text-[17px] sm:text-[20px] md:text-[22px] text-white/60 mb-12 leading-relaxed">
                        If you are ready to move beyond random posting and build a strategic, performance-driven social media presence, let's create a system that scales.
                    </p>
                    ...
                    >
                        ...
                        >
                            Schedule a Social Strategy Call
                        ...
                        <button
                            className="font-geist flex items-center justify-center transition-all duration-200 bg-white/5 text-white rounded-full font-medium hover:bg-white/10 hover:scale-[1.03] active:scale-[0.98] backdrop-blur-md border border-white/10"
                            style={{
                                padding: "10px 22px",
                                fontSize: "14px",
                            }}
