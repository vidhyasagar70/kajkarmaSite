...
const steps = [
  {
    ...
    description:
      "Audience profiling, competitor insights, and brand alignment.",
  },
  {
    number: "02.",
    title: "Content Strategy & Planning",
    description:
      "Strategic content calendar with authority-driven formats.",
  },
  {
    number: "03.",
    title: "Creative Production",
    description:
      "Modern, mobile-first visuals with consistent brand identity.",
  },
  {
    number: "04.",
    title: "Publishing & Optimization",
    description:
      "Scheduled publishing with performance-based improvements.",
  },
];
